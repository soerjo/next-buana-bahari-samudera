...
const SectionInformation = () => {
    return (
        <SectionComp id="information" classname="bg-blue-950 ">
            <div className="w-full h-full flex justify-center items-center flex-col py-8 gap-8">
                        ...
                        listdata.informations.map((information, index) => {
                            return (
                                <div key={index} className='bg-[#204D67] w-full lg:w-1/3 p-8 rounded-[8px]'>
                                    ...
                                    <p className='text-white text-sm text-justify py-4'>{information.description}</p>
                                </div>
                            )
                        })
                    }
